/*
 * datawrapper / chart 
 * generated on 2015-11-02T23:20:08+01:00
 */
...
var $chart=$('#chart1'),$body=$('body'),$notes=$chart.parent().find('.dw-chart-notes');if(!$notes.length){$notes=$('<div />').addClass('dw-chart-notes hidden');$chart.after($notes);}
...
var w=$chart.innerWidth(),h=dw.utils.getMaxChartHeight($('#chart1'));if(!$.support.leadingWhitespace)w-=10;w-=$body.css('padding-left').replace('px','');w-=$body.css('padding-right').replace('px','');var vis;if(__dw.vis&&__dw.vis.supportsSmartRendering()){vis=__dw.vis;}else{vis=__dw.vis=getVis();chart.vis(vis);}
